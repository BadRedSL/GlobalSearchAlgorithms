...
Extended fmod(const Extended& numer, const Extended& denom)
{
  Extended res;
...
#ifndef NO_MPREAL
  case etMPFR:
    *res.mpfrValue = mpfr::fmod(*numer.mpfrValue, *denom.mpfrValue);
    break;
#endif
  case etDouble:
    res.dValue = ::fmod(numer.dValue, denom.dValue);
    break;
    default:
  break;
  }
